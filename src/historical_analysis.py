...
"""
    ...
    fig, ax = plt.subplots(figsize=(6, 5))
    sc = ax.scatter(overlap['Longitude(deg)'], overlap['Latitude(deg)'], c=overlap['dz'], cmap="RdBu", vmin=-10, vmax=10, s=2, alpha=0.8)
    ...
    fig, ax = plt.subplots(figsize=(6, 5))
    sc = ax.scatter(corr_15['LON'], corr_15['LAT'], c=corr_15['ice_thickness'], cmap="Blues", s=2, alpha=0.8)
    gdf.boundary.plot(ax=ax, color="black", linewidth=1.5)
